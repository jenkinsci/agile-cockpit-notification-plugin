...
public enum Protocol {
    ...
    UDP {
        @Override
        protected void send(String url, byte[] data, int timeout, boolean isJson, String teamtoken,String encryptionkey,String vectorkey) throws IOException {
        ...
        protected void send(String url, byte[] data, int timeout, boolean isJson, String teamtoken,String encryptionkey,String vectorkey) throws IOException {
            ...
            try {
                ...
                if (307 == connection.getResponseCode()) {
                    ...
                    send(location, data, timeout, isJson, teamtoken,encryptionkey,vectorkey);
                } else {
                    connection.disconnect();
                }
            }
    ...
    protected abstract void send(String url, byte[] data, int timeout, boolean isJson, String teamtoken,String encryptionkey,String vectorkey) throws IOException;
